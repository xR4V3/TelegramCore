...
public enum OrderStatus {
    ...
    RESCHEDULED_BY_CLIENT("Перенос: по просьбе клиента", ""),
    RESCHEDULED_BY_STORE("Перенос: по вине магазина", "");
    ...
    public static String getEmojiByStatus(OrderStatus status) {
        ...
        switch (status) {
            ...
            case NOT_SHIPPED_NO_STOCK: return "⭕️";
            case NOT_SHIPPED_NO_SPACE: return "🚚";
            case NOT_SHIPPED_NOT_PICKED_FROM_DRIVER: return "🔄";
            case RESCHEDULED_BY_CLIENT, RESCHEDULED_BY_STORE: return "⏳";
            default: return "❓";
        }
    }
